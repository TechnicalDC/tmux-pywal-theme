...
set "status-right" "#[fg=$pywal_blue,bg=$pywal_black,nounderscore,noitalics]  #[fg=$pywal_white,bg=$pywal_black,nounderscore,noitalics]${time_format} #[fg=$pywal_cyan,bg=$pywal_black,nounderscore,noitalics]   #[fg=$pywal_white,bg=$pywal_black,nounderscore,noitalics]${date_format} #[fg=$pywal_visual_grey,bg=$pywal_black]#[fg=$pywal_visual_grey,bg=$pywal_visual_grey]#[fg=$pywal_white, bg=$pywal_visual_grey]${status_widgets} #[fg=$pywal_green,bg=$pywal_visual_grey,nobold,nounderscore,noitalics]#[fg=$pywal_black,bg=$pywal_green,bold] #h "
